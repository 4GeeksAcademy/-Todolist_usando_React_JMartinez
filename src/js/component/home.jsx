	...
	return (
		...
		<div className="m-auto mt-5 ">
				...
				<ul className="list-group m-auto " style={Style}>
					{
						list.map((item, index) => (
							/* 	return ( */
							<li className="fw-light list-group-item d-flex justify-content-between align-items-center list-group-item-action border border-0" style={Style} key={index}>{item}

								<a className=" cruz badge text-danger" onClick={() => pepe(index)} id={index} key={index}>
									<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class=" momia bi bi-x-square" viewBox="0 0 16 16">
			...
			<div className="monP m-auto" style={Style2}>
				<div row className="m-auto border border-top-0" id="diva" > </div>
				<div row className="m-auto border border-top-0" id="divb" > </div>
			</div>
		</div>
